...
- Link to [Long Context](26-long-context.md) when discussing context length extensions
- Link to [PEFT](19-peft.md) when discussing model adaptation (though this might be out of scope)
- Link to [Model Merging & Distillation](30-merging-distillation.md) when mentioning LLaMA 4's co-distillation
