...
- [LoRA and PEFT](19-peft.md) - Multiple mentions with context
- [RLHF](20-rlhf.md) and [DPO](21-dpo.md) - Properly positions SFT in the pipeline
- [Evaluation and Benchmarks](32-evaluation-benchmarks.md) - Good reference for metrics
