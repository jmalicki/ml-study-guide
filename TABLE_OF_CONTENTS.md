...
12. [Inference and Generation Strategies](chapters/12-inference-generation.md)
...
13. [Flash Attention](chapters/13-flash-attention.md)
    - Memory bottlenecks in attention
    - IO-aware algorithm design
    - Tiling and recomputation
    - Implementation considerations

14. [Other Efficient Attention Variants](chapters/14-efficient-attention.md)
    - Linear attention
    - Sparse attention
    - Sliding window attention
    - Multi-query and grouped-query attention

15. [KV Cache](chapters/15-kv-cache.md)
    - Why KV cache exists
...
16. [Language Model Training](chapters/16-lm-training.md)
...
19. [Supervised Fine-tuning (SFT)](chapters/18-sft.md)
    - Instruction tuning
    - Dataset preparation
    - Fine-tuning strategies

20. [LoRA and Parameter-Efficient Fine-tuning](chapters/19-peft.md)
...
21. [Reinforcement Learning from Human Feedback (RLHF)](chapters/20-rlhf.md)
    - Reward modeling
    - PPO for language models
    - KL divergence constraints
    - Implementation walkthrough

22. [Direct Preference Optimization (DPO)](chapters/21-dpo.md)
    - From RLHF to DPO
    - Mathematical derivation
    - Implementation
    - Variants (IPO, KTO, etc.)

23. [Safety and Alignment Techniques](chapters/22-safety-alignment.md)
...
24. [Long Context Techniques](chapters/23-long-context.md)
...
25. [Multimodality](chapters/24-multimodality.md)
...
26. [In-Context Learning](chapters/25-in-context-learning.md)
...
27. [Reasoning and Chain-of-Thought](chapters/26-reasoning.md)
...
28. [Architecture Comparison: Modern LLMs](chapters/27-model-architectures.md)
...
29. [Model Merging and Distillation](chapters/28-merging-distillation.md)
...
30. [Hardware, Quantization, and Training Optimization](chapters/29-hardware-quantization-optimization.md)
    - **Hardware**
...
31. [Distributed Training and Parallelism](chapters/30-distributed-training.md)
...
32. [Evaluation and Benchmarks](chapters/31-evaluation-benchmarks.md)
...
33. [Diffusion Model Fundamentals](chapters/32-diffusion-fundamentals.md)
    - Forward diffusion process
    - Reverse denoising process
    - Score matching
    - DDPM formulation

34. [Implementing Diffusion Models](chapters/33-diffusion-implementation.md)
    - U-Net architecture
    - Noise scheduling
    - Training loop
    - Sampling algorithms (DDPM, DDIM)

35. [Advanced Diffusion Topics](chapters/34-diffusion-advanced.md)
...
- [Residual Connections](appendices/residual-connections.md)
